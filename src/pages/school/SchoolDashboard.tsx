...
const SchoolDashboard = () => {
  ...
  // Derive class counts from actual student data
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <StatCard icon={BookOpen} label="Active Classes" value={Object.keys(classCounts).length} glowClass="neon-glow-purple" delay={0.3} />
